jQuery('.btn-help-button').click(function(){
  jQuery('#modal-container').toggleClass('six');
  jQuery('body').toggleClass('modal-active');
 
  jQuery('.fa-comment').toggleClass('rotate-fade-on');
  jQuery('.fa-comment').toggleClass('rotate-fade-off');
  jQuery('.fa-times').toggleClass('rotate-fade-on');
  jQuery('.fa-times').toggleClass('rotate-fade-off');

});
jQuery('.btn-no-abandon').click(function(){
  console.log('hide mobile');
  jQuery('#modal_finished').modal('hide');
});

jQuery( document ).ready(function() {
  var max_chars = 15;

  jQuery('#AccountNumber').keydown( function(e){
    console.log('down');
  ...
  jQuery('#AccountNumber').keyup( function(e){
    console.log('up');
      if (jQuery(this).val().length >= max_chars) { 
          jQuery(this).val(jQuery(this).val().substr(0, max_chars));
      }
...
/*jQuery('#modal-container').click(function(){
  ...
  jQuery('.fa-comment').toggleClass('hide');
  jQuery('.fa-times').toggleClass('hide');
});
...
/* SWITCHES BETWEEN TABS FOR FULL CURRICULUMN ACTIVITY */


/* END SWITCHES BETWEEN TABS FOR FULL CURRICULUMN ACTIVITY */
